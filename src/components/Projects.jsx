      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 lg:px-32 px-2 gap-6 mt-2">
        {projects.map((project, index) => (
          <div
            ...
            className="bg-[#fdfaf6] dark:bg-slate-950 border-2 border-blue-300 dark:border-slate-500 p-2  shadow-ku rounded-lg cursor-pointer pb-3 hover:scale-[1.01] transition-all ease-in-out"
            data-aos="fade-up"
          >
            ...
            <div className="text-slate-600 dark:text-slate-300 text-sm mb-14 " dangerouslySetInnerHTML={{ __html: truncateText(project.desc, 100) }} />
