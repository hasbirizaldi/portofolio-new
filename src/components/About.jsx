...
const About = () => {
  ...
  return (
    <section id="about" className="min-h-[110vh] bg-[#fdfaf6] dark:bg-slate-900 duration-500 flex flex-row pt-20">
      ...
      <div className="lg:w-[60%] w-[100%] lg:px-20 px-4">
        ...
        <div className={`lg:w-[70%] w-[100%] border border-blue-200 rounded-xl lg:px-6 px-4 py-4 shadow-ku ${slide ? "block" : "hidden"} animate-flip`}>
        ...
        <div className={`lg:w-[70%] w-[100%] border-2 border-blue-200 rounded-xl lg:px-6 px-4 py-4 shadow-ku ${!slide ? "block" : "hidden"} animate-flip`}>
